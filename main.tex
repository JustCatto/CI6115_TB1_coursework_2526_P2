...
\begin{document}
  ...
  \newpage
  \subsection{Photo.java:}\label{subsec:productphoto.java}
  \lstinputlisting[language=Java,label={lst:productphoto}]{src/main/java/Photo.java}
  ...
  \subsection{4b)}\label{subsec:4b-and-c}
  \begin{figure}[H]
    \includegraphics[width=\linewidth]{q4b}
    \label{fig:q4b}
  \end{figure}

  \subsection{4c}\label{subsec:4c}
  \begin{figure}[H]
      \includegraphics[width=\linewidth]{q4c}\label{fig:q4c}
  \end{figure}
  ...
  refactoring (3 marks).
  As seen in the appendix in figure 5s code, this code has a couple of code smells.
  \begin{itemize}
 ...
 board.py@41 onwards, the placePiece function is quite long and can be broken into individual steps.
  ...
  \subsubsection{Item}\label{subsubsec:q3-code-item}
  \lstinputlisting[language=Java,label={lst:q3-item}]{src/main/java/Item.java}
  \subsubsection{Factory}\label{subsubsec:q3-code-factory}
  \lstinputlisting[language=Java,label={lst:q3-factory}]{src/main/java/Factory.java}

  \subsubsection{Book}\label{subsubsec:q3-code-book}
  \lstinputlisting[language=Java,label={lst:q3-book}]{src/main/java/Book.java}
  \subsubsection{BookFactory}\label{subsubsec:q3-code-bookfactory}
  \lstinputlisting[language=Java,label={lst:q3-bookfactory}]{src/main/java/BookFactory.java}

  \subsubsection{Magazine}\label{subsubsec:q3-code-magazine}
  \lstinputlisting[language=Java,label={lst:q3-magazine}]{src/main/java/Magazine.java}
  \subsubsection{MagazineFactory}
  \lstinputlisting[language=Java,label={lst:q3-magazinefactory}]{src/main/java/MagazineFactory.java}

  \subsubsection{Notebook}\label{subsubsec:q3-code-notebook}
  \lstinputlisting[language=Java,label={lst:q3-notebook}]{src/main/java/Notebook.java}
  \subsubsection{BookFactory}
  \lstinputlisting[language=Java,label={lst:q3-notebookfactory}]{src/main/java/NotebookFactory.java}

  \subsection{Q4 Code}\label{subsec:q4-code}
  \subsubsection{OrderProcessor, Observer, Observable}
  \lstinputlisting[language=Java,label={lst:q3-observables}]{src/main/java/q4/OrderProcessor.java}

  \subsubsection{EmailSystem}
  \lstinputlisting[language=Java,label={lst:q3-emailsystem}]{src/main/java/q4/EmailSystem.java}

  \subsubsection{InventoryManagement}
  \lstinputlisting[language=Java,label={lst:q3-InventoryManagement}]{src/main/java/q4/InventoryManagement.java}

  \subsubsection{OrderTracking}
  \lstinputlisting[language=Java,label={lst:q3-OrderTracking}]{src/main/java/q4/OrderTracking.java}

  \subsubsection{Main}
  \lstinputlisting[language=Java,label={lst:q3-Main}]{src/main/java/q4/Main.java}
